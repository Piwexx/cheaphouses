...
insert into faqs (question, answer, link_text, link_href, sort_order) values
  ...
  ('Is it free?', 'Browsing is free — you can see listings and prices. Full access, including direct seller contacts, renovation estimates, and the complete archive, requires a Membership. $10/month billed annually, or $15/month month-to-month.', null, null, 5),
